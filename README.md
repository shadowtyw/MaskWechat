...
v1.7版本开始新增功能：当Wechat主页发起的搜索结果命中糊脸ID时，将隐藏所在行视图

v2.2版本变更：开启sql hook，通过拦截并修改sql实现搜索功能过滤掉指定用户，从而避免搜出。对应微信版本8.0.49，其他版本也开启，但未测试。
...
答：官网去下载，比对下sha1。当然，正常来说版本号相同就支持。
